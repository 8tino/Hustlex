...
const FOODS = [
  ...
  // ── Gemüse & Obst ──
  { id: 'f21', n: 'Brokkoli 200g',        kcal: 70,  p: 6,  c: 8,  f: 1,  ic: '🥦', cat: 'Gemüse & Obst' },
  { id: 'f22', n: 'Spinat 100g',          kcal: 25,  p: 3,  c: 2,  f: 0,  ic: '🥬', cat: 'Gemüse & Obst' },
  { id: 'f23', n: 'Gemischter Salat',     kcal: 40,  p: 2,  c: 6,  f: 0,  ic: '🥗', cat: 'Gemüse & Obst' },
  { id: 'f24', n: 'Avocado ½',            kcal: 160, p: 2,  c: 9,  f: 15, ic: '🥑', cat: 'Gemüse & Obst' },
  { id: 'f25', n: 'Banane',               kcal: 105, p: 1,  c: 27, f: 0,  ic: '🍌', cat: 'Gemüse & Obst' },
  { id: 'f26', n: 'Apfel',                kcal: 95,  p: 0,  c: 25, f: 0,  ic: '🍎', cat: 'Gemüse & Obst' },
  { id: 'f27', n: 'Beeren 150g',          kcal: 85,  p: 1,  c: 18, f: 1,  ic: '🫐', cat: 'Gemüse & Obst' },
  // ── Fette & Snacks ──
  ...
  // ── Gemüse ──
  { id: 'f51', n: 'Karotte 100g',         kcal: 40,  p: 1,  c: 9,  f: 0,  ic: '🥕', cat: 'Gemüse & Obst' },
  { id: 'f52', n: 'Paprika 100g',         kcal: 30,  p: 1,  c: 6,  f: 0,  ic: '🫑', cat: 'Gemüse & Obst' },
  { id: 'f53', n: 'Tomaten 150g',         kcal: 27,  p: 1,  c: 5,  f: 0,  ic: '🍅', cat: 'Gemüse & Obst' },
  { id: 'f54', n: 'Gurke 150g',           kcal: 22,  p: 1,  c: 4,  f: 0,  ic: '🥒', cat: 'Gemüse & Obst' },
  { id: 'f55', n: 'Zucchini 150g',        kcal: 25,  p: 2,  c: 5,  f: 0,  ic: '🥒', cat: 'Gemüse & Obst' },
  { id: 'f56', n: 'Blumenkohl 150g',      kcal: 38,  p: 3,  c: 7,  f: 0,  ic: '🥦', cat: 'Gemüse & Obst' },
  { id: 'f57', n: 'Grünkohl 100g',        kcal: 35,  p: 3,  c: 4,  f: 1,  ic: '🥬', cat: 'Gemüse & Obst' },
  { id: 'f58', n: 'Rosenkohl 150g',       kcal: 65,  p: 5,  c: 13, f: 1,  ic: '🥬', cat: 'Gemüse & Obst' },
  { id: 'f59', n: 'Rote Bete 150g',       kcal: 65,  p: 2,  c: 15, f: 0,  ic: '🥬', cat: 'Gemüse & Obst' },
  { id: 'f60', n: 'Kürbis 200g',          kcal: 52,  p: 2,  c: 12, f: 0,  ic: '🎃', cat: 'Gemüse & Obst' },
  { id: 'f61', n: 'Champignons 150g',     kcal: 33,  p: 5,  c: 5,  f: 0,  ic: '🍄', cat: 'Gemüse & Obst' },
  { id: 'f62', n: 'Zwiebel 100g',         kcal: 40,  p: 1,  c: 9,  f: 0,  ic: '🧅', cat: 'Gemüse & Obst' },
  { id: 'f63', n: 'Knoblauch 15g',        kcal: 22,  p: 1,  c: 5,  f: 0,  ic: '🧄', cat: 'Gemüse & Obst' },
  { id: 'f64', n: 'Spargel 150g',         kcal: 30,  p: 3,  c: 6,  f: 0,  ic: '🥬', cat: 'Gemüse & Obst' },
  { id: 'f65', n: 'Aubergine 150g',       kcal: 38,  p: 1,  c: 9,  f: 0,  ic: '🍆', cat: 'Gemüse & Obst' },
  { id: 'f66', n: 'Rucola 40g',           kcal: 10,  p: 1,  c: 1,  f: 0,  ic: '🥬', cat: 'Gemüse & Obst' },
  { id: 'f67', n: 'Grüne Bohnen 150g',    kcal: 47,  p: 3,  c: 10, f: 0,  ic: '🫛', cat: 'Gemüse & Obst' },
  { id: 'f68', n: 'Erbsen 150g',          kcal: 120, p: 8,  c: 21, f: 1,  ic: '🫛', cat: 'Gemüse & Obst' },
  { id: 'f69', n: 'Mais 150g',            kcal: 130, p: 5,  c: 28, f: 2,  ic: '🌽', cat: 'Gemüse & Obst' },

  // ── Obst ──
  { id: 'f70', n: 'Orange',               kcal: 62,  p: 1,  c: 15, f: 0,  ic: '🍊', cat: 'Gemüse & Obst' },
  { id: 'f71', n: 'Birne',                kcal: 100, p: 1,  c: 27, f: 0,  ic: '🍐', cat: 'Gemüse & Obst' },
  { id: 'f72', n: 'Trauben 100g',         kcal: 70,  p: 1,  c: 18, f: 0,  ic: '🍇', cat: 'Gemüse & Obst' },
  { id: 'f73', n: 'Erdbeeren 150g',       kcal: 50,  p: 1,  c: 12, f: 0,  ic: '🍓', cat: 'Gemüse & Obst' },
  { id: 'f74', n: 'Kiwi x2',              kcal: 90,  p: 2,  c: 22, f: 1,  ic: '🥝', cat: 'Gemüse & Obst' },
  { id: 'f75', n: 'Ananas 150g',          kcal: 75,  p: 1,  c: 20, f: 0,  ic: '🍍', cat: 'Gemüse & Obst' },
  { id: 'f76', n: 'Mango 150g',           kcal: 90,  p: 1,  c: 23, f: 0,  ic: '🥭', cat: 'Gemüse & Obst' },
  { id: 'f77', n: 'Wassermelone 200g',    kcal: 60,  p: 1,  c: 15, f: 0,  ic: '🍉', cat: 'Gemüse & Obst' },
  { id: 'f78', n: 'Pfirsich',             kcal: 60,  p: 1,  c: 14, f: 0,  ic: '🍑', cat: 'Gemüse & Obst' },
  { id: 'f79', n: 'Kirschen 150g',        kcal: 95,  p: 2,  c: 24, f: 0,  ic: '🍒', cat: 'Gemüse & Obst' },
  { id: 'f80', n: 'Granatapfel ½',        kcal: 70,  p: 1,  c: 17, f: 1,  ic: '🔴', cat: 'Gemüse & Obst' },
  { id: 'f81', n: 'Datteln x3',           kcal: 200, p: 2,  c: 53, f: 0,  ic: '🌴', cat: 'Gemüse & Obst' },
  { id: 'f82', n: 'Zitrone',              kcal: 17,  p: 1,  c: 5,  f: 0,  ic: '🍋', cat: 'Gemüse & Obst' },
  { id: 'f83', n: 'Grapefruit ½',         kcal: 52,  p: 1,  c: 13, f: 0,  ic: '🍊', cat: 'Gemüse & Obst' },
